...
- (void)initExample {
    ...
    [donutSeries.segmentsCollection add:[self segmentWithValue:40 title:@"Green" centerColor:0xFF34c19c edgeColor:0xFF34c19c]];
    [donutSeries.segmentsCollection add:[self segmentWithValue:10 title:@"Red" centerColor:0xFFc43360 edgeColor:0xFFc43360]];
    [donutSeries.segmentsCollection add:[self segmentWithValue:20 title:@"Blue" centerColor:0xFF373dbc edgeColor:0xFF373dbc]];
    [donutSeries.segmentsCollection add:[self segmentWithValue:15 title:@"Yellow" centerColor:0xffe8c667 edgeColor:0xffe8c667]];
