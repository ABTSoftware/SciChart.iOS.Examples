...
//
// DigitalBandChartView.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class DigitalBandChartView: SCDSingleChartViewController<SCIChartSurface> {
    ...
    override func initExample() {
        ...
        let moreData = SCDDataManager.getDampedSinewave(withAmplitude: 1.0, dampingFactor: 0.05, pointCount: 1000, freq: 12)
