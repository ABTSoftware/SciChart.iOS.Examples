...
//
// SCDPopulationLabelProvider.m is part of the SCICHART® Examples. Permission is hereby granted
...
@implementation PopulationLabelProvider

- (id<ISCIString>)formatLabel:(id<ISCIComparable>)dataValue {
    int myInt = (int)[SCIComparableUtil toDouble:dataValue];
    return [NSString stringWithFormat:@"%@", [self setXValueWithAgeRange:myInt]];
}
...
- (NSString*)setXValueWithAgeRange:(int)ind{
    switch (ind) {
        case 0: return @"100+";
        case 1: return @"95-99";
        case 2: return @"90-94";
