...
//
// SCSTooltipCustomizationChartView.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class SCSTooltipCustomizationChartView: SingleChartLayout {
