...
//
// SCSUsingRolloverModifierChartView.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class SCSUsingRolloverModifierChartView: UIView {
    ...
    fileprivate func getFastLineRenderableSeries(_ pointMarker: SCIEllipsePointMarker?, amplitude: Double, colorCode: uint) -> SCIFastLineRenderableSeries {
        ...
        fourierRenderableSeries.addAnimation(SCISweepRenderableSeriesAnimation(duration: 3, curveAnimation: .easeOut))
