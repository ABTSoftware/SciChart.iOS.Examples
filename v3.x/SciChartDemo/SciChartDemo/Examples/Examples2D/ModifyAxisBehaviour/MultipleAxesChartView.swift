...
class MultipleAxesChartView: SingleChartLayout {
    ...
    override func initExample() {
        ...
        let modifierGroup = ExampleViewBase.createDefaultModifiers()
        modifierGroup.childModifiers.add(SCILegendModifier())
        modifierGroup.childModifiers.add(SCIXAxisDragModifier())
        modifierGroup.childModifiers.add(SCIYAxisDragModifier())
