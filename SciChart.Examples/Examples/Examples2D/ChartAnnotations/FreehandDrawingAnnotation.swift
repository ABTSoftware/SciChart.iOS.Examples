...
//
// FreehandDrawingAnnotation.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class FreehandDrawingAnnotation: SCDFreehandAnnotationChartViewController<SCIChartSurface>{
    ...
    override func initExample() {
        ...
        SCIUpdateSuspender.usingWith(surface) {
            ...
            self.surface.chartModifiers.add(items:self.freeHandModifier, SCIPinchZoomModifier(), SCIZoomExtentsModifier(), self.zoomPanModifier)
        }
