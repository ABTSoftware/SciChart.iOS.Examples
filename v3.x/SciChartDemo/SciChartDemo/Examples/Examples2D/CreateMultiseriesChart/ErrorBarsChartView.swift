...
class ErrorBarsChartView: SingleChartLayout {
    ...
    override func initExample() {
        ...
        SCIUpdateSuspender.usingWith(surface) {
            ...
            self.surface.renderableSeries.add(items: lineSeries, scatterSeries, errorBars0, errorBars1)
            ...
            SCIAnimations.scale(errorBars0, duration: 3.0, andEasingFunction: SCIElasticEase())
            SCIAnimations.scale(errorBars1, duration: 3.0, andEasingFunction: SCIElasticEase())
        }
    }
