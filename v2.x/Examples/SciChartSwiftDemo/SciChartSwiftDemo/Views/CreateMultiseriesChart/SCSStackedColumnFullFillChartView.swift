...
//
// SCSStackedColumnFullFillChartView.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class SCSStackedColumnFullFillChartView: SingleChartLayout {
    ...
    override func initExample() {
        ...
        columnCollection.isOneHundredPercentSeries = true
