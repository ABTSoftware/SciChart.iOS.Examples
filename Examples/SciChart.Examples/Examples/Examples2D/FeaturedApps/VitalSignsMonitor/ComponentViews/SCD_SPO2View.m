...
//
// SCD_SPO2View.m is part of the SCICHART® Examples. Permission is hereby granted
...
- (instancetype)initWithTopLeftView:(SCIView *)topLeftView topRightView:(SCIView *)topRightView bottomLeftView:(SCIView *)bottomLeftView bottomRightView:(SCIView *)bottomRightView {
    ...
    if (self) {
        _spoClockValueLabel = (SCILabel *)topRightView;
        _spoValueLabel = (SCILabel *)bottomRightView;
    }
    return self;
}
