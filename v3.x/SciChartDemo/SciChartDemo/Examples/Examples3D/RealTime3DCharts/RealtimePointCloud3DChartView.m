...
- (void)initExample {
    ...
    _ds = [[SCIXyzDataSeries3D alloc] initWithXType:SCIDataType_Double yType:SCIDataType_Double zType:SCIDataType_Double];
    [_ds appendXValues:_xData yValues:_yData zValues:_zData];
...
- (void)updateData {
    ...
    [_ds updateXValues:_xData yValues:_yData zValues:_zData at:0];
}
