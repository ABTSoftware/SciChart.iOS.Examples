...
- (void)initExample {
    ...
    mountainSeries.paletteProvider = [[XyCustomPaletteProvider alloc] initWithColor:UIColor.redColor annotation:boxAnnotation];
    ...
    ellipsePointMarker.strokeStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.orangeColor thickness:2.0];
    ...
    lineSeries.paletteProvider = [[XyCustomPaletteProvider alloc] initWithColor:UIColor.redColor annotation:boxAnnotation];

    SCIFastOhlcRenderableSeries *ohlcSeries = [SCIFastOhlcRenderableSeries new];
    ohlcSeries.dataSeries = ohlcDataSeries;
    ohlcSeries.paletteProvider = [[OhlcCustomPaletteProvider alloc] initWithColor:UIColor.blueColor annotation:boxAnnotation];
    ...
    candlestickSeries.paletteProvider = [[OhlcCustomPaletteProvider alloc] initWithColor:UIColor.greenColor annotation:boxAnnotation];

    SCIFastColumnRenderableSeries *columnSeries = [SCIFastColumnRenderableSeries new];
    columnSeries.dataSeries = columnDataSeries;
    columnSeries.strokeStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.blueColor thickness:1];
    columnSeries.zeroLineY = 6000;
    columnSeries.fillBrushStyle = [[SCISolidBrushStyle alloc] initWithColor:UIColor.blueColor];
    columnSeries.paletteProvider = [[XyCustomPaletteProvider alloc] initWithColor:UIColor.purpleColor annotation:boxAnnotation];
    ...
    squarePointMarker.strokeStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.orangeColor thickness:2.0];
    ...
    scatterSeries.paletteProvider = [[XyCustomPaletteProvider alloc] initWithColor:UIColor.greenColor annotation:boxAnnotation];
