...
//
// SCDDynamicAnnotationsViewController.m is part of the SCICHART® Examples. Permission is hereby granted
...
@interface SCDDynamicAnnotationsViewController()

@end

@implementation SCDDynamicAnnotationsViewController {
