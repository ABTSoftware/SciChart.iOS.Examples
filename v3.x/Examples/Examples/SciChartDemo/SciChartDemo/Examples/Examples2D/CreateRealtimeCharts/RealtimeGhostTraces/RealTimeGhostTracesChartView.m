...
- (void)updateData:(NSTimer *)timer {
    [SCIUpdateSuspender usingWithSuspendable:self.surface withBlock:^{
        ...
        double randomAmplitude = _lastAmplitude + ([SCDRandomUtil nextDouble] - 0.5);
        ...
        SCDDoubleSeries *noisySinewave = [SCDDataManager getNoisySinewaveWithAmplitude:randomAmplitude Phase:_phase PointCount:1000 NoiseAmplitude:0.25];
