...
class BubbleChartView: SingleChartLayout {
    ...
    override func initExample() {
        ...
        let rSeries = SCIFastBubbleRenderableSeries();
        ...
        SCIUpdateSuspender.usingWith(surface) {
            ...
            // RubberBand modifier here
            self.surface.chartModifiers.add(SCIZoomExtentsModifier())
            
            SCIAnimations.scale(rSeries, withZeroLine: 10600.0, duration: 3.0, andEasingFunction: SCIElasticEase())
