...
class LidarPointCloud: SingleChartLayout3D {
    let LIDARTQ38sw = "tq3080_DSM_2M.asc"
    
    let colorMap = SCIColorMap(colors: [UIColor.fromARGBColorCode(0xFF1E90FF), UIColor.fromARGBColorCode(0xFF32CD32), .orange, .red, .purple], andStops: [0, 0.2, 0.5, 0.7, 1])
