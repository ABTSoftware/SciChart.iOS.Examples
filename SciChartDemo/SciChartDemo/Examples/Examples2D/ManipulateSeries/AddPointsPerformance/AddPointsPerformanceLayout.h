...
@property (nonatomic, copy) SCIAction append10K;
@property (nonatomic, copy) SCIAction append100K;
@property (nonatomic, copy) SCIAction append1Mln;
@property (nonatomic, copy) SCIAction clear;
