...
//
// AppendSpeedTestCorePlot.swift is part of the SCICHART® PerformanceComparison.
...
class AppendSpeedTestCorePlot: CorePlotSpeedTestBase, CPTScatterPlotDataSource {
    ...
    override func updateChart(testParameters: TestParameters) {
        for _ in 0..<testParameters.appendPoints {
            ...
            yValues.append(randomWalkGenerator.next(min: -0.5, max: 0.5, includePrior: true))
            xCount += 1
        }
