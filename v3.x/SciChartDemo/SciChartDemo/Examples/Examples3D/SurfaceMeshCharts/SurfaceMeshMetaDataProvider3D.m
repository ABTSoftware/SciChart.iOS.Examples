...
- (void)updateMeshColors:(SCIUnsignedIntegerValues *)cellColors {
    if (![self.renderableSeries.currentRenderPassData isKindOfClass:SCISurfaceMeshRenderPassData3D.class]) {
        return;
    }
    ...
    int countX = currentRenderPassData.countX - 1;
    int countZ = currentRenderPassData.countZ - 1;
