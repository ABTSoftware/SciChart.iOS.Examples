...
//
// SCSInteractionWithAnnotations.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class SCSInteractionWithAnnotations: SingleChartLayout {
