...
//
// SCDBrushModifierChartViewController.h is part of the SCICHART® Examples. Permission is hereby granted
...
@interface SCDBrushModifierChartViewController<TSurface: SCIView<ISCIChartSurfaceBase> *> : SCDExampleBaseViewController
...
@property (nonatomic) SCIFreehandDrawingModifier *brushModifier;
