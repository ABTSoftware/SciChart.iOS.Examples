...
class AnnotationsAreEasyView: SingleChartLayout {
    ...
    override func initExample() {
        ...
        SCIUpdateSuspender.usingWith(surface) {
            ...
            customAnnotationGreen.customView = UIImageView(image: #imageLiteral(resourceName: "image.arrow.green"))
            customAnnotationGreen.set(x1: 8)
            customAnnotationGreen.set(y1: 5.5)
            
            let customAnnotationRed = SCICustomAnnotation()
            customAnnotationRed.customView = UIImageView(image: #imageLiteral(resourceName: "image.arrow.red"))
            ...
            horizontalLine1.stroke = SCISolidPenStyle(color: UIColor.orange, thickness: 2)
            ...
            self.surface.annotations = SCIAnnotationCollection(collection: [watermark, textAnnotation1, textAnnotation2, textAnnotation3,
