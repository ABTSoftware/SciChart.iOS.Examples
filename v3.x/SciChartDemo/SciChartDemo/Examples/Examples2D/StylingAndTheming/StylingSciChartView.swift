...
class StylingSciChartView: SingleChartLayout {
    ...
    override func initExample() {
        ...
        xAxis.tickLabelStyle = SCIFontStyle(fontDescriptor: UIFontDescriptor(name: "Courier-Bold", size: 14.0), andTextColor: .purple)
        ...
        yRightAxis.tickLabelStyle = SCIFontStyle(fontDescriptor: UIFontDescriptor(name: "Helvetica", size: 14.0), andTextColor: .green)
        ...
        yLeftAxis.tickLabelStyle = SCIFontStyle(fontDescriptor: UIFontDescriptor(name: "Helvetica", size: 12.0), andTextColor: .purple)
