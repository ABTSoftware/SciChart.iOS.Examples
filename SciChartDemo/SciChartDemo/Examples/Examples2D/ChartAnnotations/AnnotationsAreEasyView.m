...
- (void)initExample  {
    ...
    [SCIUpdateSuspender usingWithSuspendable:self.surface withBlock:^{
        ...
        textAnnotation1.fontStyle = [[SCIFontStyle alloc] initWithFontSize:22 andTextColor:UIColor.whiteColor];
        ...
        textAnnotation2.fontStyle = [[SCIFontStyle alloc] initWithFontSize:12 andTextColor:UIColor.whiteColor];
        ...
        editableTextAnnotation.fontStyle = [[SCIFontStyle alloc] initWithFontSize:12 andTextColor:UIColor.whiteColor];
        ...
        textAnnotation6.fontStyle = [[SCIFontStyle alloc] initWithFontSize:12 andTextColor:UIColor.whiteColor];
        ...
        textAnnotation7.fontStyle = [[SCIFontStyle alloc] initWithFontSize:12 andTextColor:UIColor.whiteColor];
        ...
        textAnnotation8.fontStyle = [[SCIFontStyle alloc] initWithFontSize:12 andTextColor:UIColor.whiteColor];
        
        SCICustomAnnotation *customAnnotationGreen = [SCICustomAnnotation new];
        customAnnotationGreen.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"image.arrow.green"]];
        customAnnotationGreen.x1 = @(8);
        customAnnotationGreen.y1 = @(5.5);
        
        SCICustomAnnotation *customAnnotationRed = [SCICustomAnnotation new];
        customAnnotationRed.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"image.arrow.red"]];
        ...
        horizontalLine.stroke = [[SCISolidPenStyle alloc] initWithColor:UIColor.orangeColor thickness:2];
        ...
        horizontalLine1.stroke = [[SCISolidPenStyle alloc] initWithColor:UIColor.orangeColor thickness:2];
        ...
        self.surface.annotations = [[SCIAnnotationCollection alloc] initWithCollection:@[watermark, textAnnotation1, textAnnotation2, textAnnotation3,
                                                                                         editableTextAnnotation, textAnnotation4, textAnnotation5,
                                                                                         textAnnotation6, lineAnnotation, lineArrowAnnotation,
