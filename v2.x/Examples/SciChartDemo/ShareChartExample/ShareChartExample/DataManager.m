...
-(SCDMultiPaneItem *) getNextRandomPriceBar{
    ...
    NSDate *closeTime = [openTime addTimeInterval:_candleIntervalMinutes];
...
-(NSDate *) emulateDateGap: (NSDate *) candleOpenTime{
    ...
    if ([candleOpenTime timeIntervalSince1970] > _closeMarketTime)
    {
        ...
        dateTime = [dateTime addTimeInterval: 500];
        result = [dateTime addTimeInterval:_openMarketTime];
    }
    while ([result timeIntervalSince1970] < 500)
    {
        result = [result addTimeInterval: 500];
    }
    return result;
}
