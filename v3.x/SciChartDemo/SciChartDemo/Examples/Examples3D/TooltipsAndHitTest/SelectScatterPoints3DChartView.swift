...
class SelectScatterPoints3DChartView: SingleChartLayout3D {
    ...
    override func initExample() {
        ...
        SCIUpdateSuspender.usingWith(surface) {
            ...
            self.surface.chartModifiers.add(items: SCIPinchZoomModifier3D(), SCIVertexSelectionModifier3D(), zoomExtentsModifier, SCIOrbitModifier3D(defaultNumberOfTouches: 2))
        }
    }
}
