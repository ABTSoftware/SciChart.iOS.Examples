...
//
// SCDFreehandAnnotationChartViewController.m is part of the SCICHART® Examples. Permission is hereby granted
...
@implementation SCDFreehandAnnotationChartViewController {
...
@synthesize freeHandModifier = _freeHandModifier;
...
#endif
    self.freeHandModifier.stroke = [[SCISolidPenStyle alloc] initWithColorCode:_strokeColor thickness:_thickness];
}
...
-(IBAction)drawSwitchAction:(SCISwitch*)sender {
    ...
    _freeHandModifier.isEnabled = isOn;
    _zoomPanModifier.isEnabled = !isOn;
}

-(IBAction)btnDeleteAction:(SCIButton*)sender {
    [self.freeHandModifier deleteSelectedAnnotations];
}
