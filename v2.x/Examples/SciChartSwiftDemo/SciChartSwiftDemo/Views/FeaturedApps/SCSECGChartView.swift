...
//
// SCSECGChartView.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class SCSECGChartView: SingleChartLayout {
    ...
    override func willMove(toSuperview newSuperview: UIView?) {
        ...
        if _timer == nil {
            _timer = Timer.scheduledTimer(timeInterval: 0.04, target: self, selector: #selector(appendData), userInfo: nil, repeats: true)
        } else {
            _timer.invalidate()
            _timer = nil
        }
