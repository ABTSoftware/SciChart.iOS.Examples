...
//
// SelectScatterPoints3DChartView.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class SelectScatterPoints3DChartView: SCDSingleChartViewController<SCIChartSurface3D> {
    ...
    override func initExample() {
        ...
        let pointMarker = SCIEllipsePointMarker3D()
        ...
        SCIUpdateSuspender.usingWith(surface) {
            ...
            self.surface.chartModifiers.add(items: SCIPinchZoomModifier3D(), SCIVertexSelectionModifier3D(), SCIOrbitModifier3D(defaultNumberOfTouches: 2))
        }
    }
}
