...
- (void)initExample {
    ...
    textAnnotation1.fontStyle = [[SCIFontStyle alloc] initWithFontSize:20 andTextColor:UIColor.whiteColor];
    ...
    textAnnotation2.fontStyle = [[SCIFontStyle alloc] initWithFontSize:20 andTextColor:UIColor.whiteColor];
    ...
    rotatedTextAnnotation.fontStyle = [[SCIFontStyle alloc] initWithFontSize:20 andTextColor:UIColor.whiteColor];
    ...
    horizontalLine1.stroke = [[SCISolidPenStyle alloc] initWithColor: [UIColor redColor] thickness:2];
    ...
    horizontalLine2.stroke = [[SCISolidPenStyle alloc] initWithColor: [UIColor blueColor] thickness:2];
