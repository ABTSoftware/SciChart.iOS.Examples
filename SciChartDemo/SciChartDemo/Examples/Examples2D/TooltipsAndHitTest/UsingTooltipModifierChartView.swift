...
class UsingTooltipModifierChartView: SingleChartLayout {
    ...
    override func initExample() {
        ...
        line1.strokeStyle = SCISolidPenStyle(color: UIColor(red: 70.0 / 255.0, green: 130.0 / 255.0, blue: 180.0 / 255.0, alpha: 1.0), thickness: 0.5)
        ...
        line2.strokeStyle = SCISolidPenStyle(color: UIColor(red: 255.0 / 255.0, green: 51.0 / 255.0, blue: 51.0 / 255.0, alpha: 1.0), thickness: 0.5)
