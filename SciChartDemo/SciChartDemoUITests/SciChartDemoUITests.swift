...
class SciChartDemoUITests: XCTestCase {
    ...
    func testGenerateScreenshots() {
        ...
        // Open FEATURED APPS
        app.collectionViews.cells.otherElements.containing(.staticText, identifier:"FEATURED APPS").element.firstMatch.tap()
        ...
        app.navigationBars["Waterfall Chart 3D"].buttons["charts"].tap()
        
        // Logarithmic Axis
        app.tables.staticTexts["Logarithmic Axis 3D"].tap()
        app.children(matching: .window).element(boundBy: 0).swipeDown()
        snapshot("5-Logarithmic-Axis-3D", timeWaitingForIdle: timeWaitingFor3D)
        app.navigationBars["Logarithmic Axis 3D"].buttons["charts"].tap()
        ...
        // Open 2D CHARTS
        app.collectionViews.cells.otherElements.containing(.staticText, identifier:"2D CHARTS").element.firstMatch.tap()
        
        // Candlestick
        app.tables.staticTexts["Candlestick Chart"].tap()
        snapshot("6-Candlestick", timeWaitingForIdle: timeWaitingFor2D)
        app.navigationBars["Candlestick Chart"].buttons["charts"].tap()
        ...
        app.navigationBars["Vertically Stacked Axes"].buttons["charts"].tap()
        
        // Scatter
        app.tables.staticTexts["Scatter Chart"].tap()
        snapshot("8-Scatter", timeWaitingForIdle: timeWaitingFor2D)
        app.navigationBars["Scatter Chart"].buttons["charts"].tap()
