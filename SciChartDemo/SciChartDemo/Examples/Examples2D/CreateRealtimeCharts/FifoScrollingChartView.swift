...
class FifoScrollingChartView: RealtimeChartLayout {
    ...
    override func initExample() {
        ...
        rs1.dataSeries = _ds1
        rs1.strokeStyle = SCISolidPenStyle(colorCode: 0xFF4083B7, thickness: 2)
        
        let rs2 = SCIFastLineRenderableSeries()
        rs2.dataSeries = _ds2
        rs2.strokeStyle = SCISolidPenStyle(colorCode: 0xFFFFA500, thickness: 2)
        
        let rs3 = SCIFastLineRenderableSeries()
        rs3.dataSeries = _ds3
        rs3.strokeStyle = SCISolidPenStyle(colorCode: 0xFFE13219, thickness: 2)
