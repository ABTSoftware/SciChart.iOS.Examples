...
//
// SCD_NIBPView.m is part of the SCICHART® Examples. Permission is hereby granted
...
- (instancetype)initWithTopLeftView:(SCIView *)topLeftView topRightView:(SCIView *)topRightView bottomLeftView:(SCIView *)bottomLeftView bottomRightView:(SCIView *)bottomRightView {
    ...
    if (self) {
        _bpBar = (SCDStepProgressBar *)bottomLeftView;
        _bpValueLabel = (SCILabel *)bottomRightView;
    }
    return self;
}
