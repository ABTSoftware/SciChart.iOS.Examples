...
class FFTPaletteProvider: SCIPaletteProviderBase<SCIFastColumnRenderableSeries>, ISCIFillPaletteProvider, ISCIStrokePaletteProvider {
    ...
    private struct Colors {
        ...
        static let minColorRed = UIColor.red(minColor)
        static let minColorGreen = UIColor.green(minColor)
        static let minColorBlue = UIColor.blue(minColor)
        
        // RGB chanel values for max color
        static let maxColorRed = UIColor.red(maxColor)
        static let maxColorGreen = UIColor.green(maxColor)
        static let maxColorBlue = UIColor.blue(maxColor)
