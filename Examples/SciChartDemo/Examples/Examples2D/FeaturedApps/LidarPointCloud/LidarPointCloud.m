...
- (void)initExample {
    SCIColorMap *colorMap = [[SCIColorMap alloc] initWithColors:@[[UIColor fromARGBColorCode:0xFF1E90FF], [UIColor fromARGBColorCode:0xFF32CD32], UIColor.orangeColor, UIColor.redColor, UIColor.purpleColor] andStops:@[@(0), @(0.2), @(0.5), @(0.7), @(1)]];
    ...
    unsigned int fillColors[5] = { 0xFF1E90FF, 0xFF32CD32, UIColor.orangeColor.colorARGBCode, UIColor.redColor.colorARGBCode, UIColor.purpleColor.colorARGBCode };
