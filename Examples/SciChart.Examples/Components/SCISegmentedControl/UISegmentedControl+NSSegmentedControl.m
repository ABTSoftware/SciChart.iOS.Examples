...
//
// UISegmentedControl+NSSegmentedControl.m is part of the SCICHART® Examples. Permission is hereby granted
...
@implementation UISegmentedControl (NSSegmentedControl)
