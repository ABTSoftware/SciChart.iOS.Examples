        ...
        self.examples2D = [NSDictionary dictionaryWithObjects:@[
                                                                ...
                                                                @[ [[SCDExampleItem alloc] initWithExampleName:@"StackedMountain Chart"
                                                                   ...
                                                                   [[SCDExampleItem alloc] initWithExampleName:@"Stacked Bar Chart"
                                                                                            exampleDescription:@"Generates a Stacked Column 100% chart in code."
                                                                                                   exampleIcon:@"ColumnChart"
                                                                                                   exampleFile:@"StackedBarChartView"]],
                                                                ...
                                                                @[ [[SCDExampleItem alloc] initWithExampleName:@"ECG Monitor Demo"
                                                                   ...
                                                                   [[SCDExampleItem alloc] initWithExampleName:@"Multiple X Axes"
                                                                                            exampleDescription:@"Demonstrates a line chart with four series and multiple top / bottom X-Axis and left / right Y-Axis"
                                                                                                   exampleIcon:@"LineChart"
                                                                   ...
                                                                   [[SCDExampleItem alloc] initWithExampleName:@"Sync Multi Chart"
                                                                                            exampleDescription:@"Showcases how to synchronize axis ranges across multiple charts"
                                                                                                   exampleIcon:@"LineChart"
