...
- (void)initExample {
    ...
    UIFontDescriptor *tickFontDescriptor = [UIFontDescriptor fontDescriptorWithName:@"Courier-Bold" size:14];
    UIFontDescriptor *titleFontDescriptor =  [UIFontDescriptor fontDescriptorWithName:@"Courier-Bold" size:18];
    ...
    xAxis.majorGridLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.greenColor thickness:1];
    xAxis.minorGridLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.yellowColor thickness:0.5 strokeDashArray:@[@(10.f), @(3.f), @(10.f), @(3.f)]];
    
    xAxis.tickLabelStyle = [[SCIFontStyle alloc] initWithFontDescriptor:tickFontDescriptor andTextColor:UIColor.purpleColor];
    xAxis.titleStyle = [[SCIFontStyle alloc] initWithFontDescriptor:titleFontDescriptor andTextColor:UIColor.purpleColor];
    ...
    xAxis.majorTickLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.greenColor thickness:1];
    xAxis.minorTickLineLength = 2;
    xAxis.minorTickLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.yellowColor thickness:0.5];
    ...
    yRightAxis.majorGridLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.greenColor thickness:1];
    yRightAxis.minorGridLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.yellowColor thickness:0.5 strokeDashArray:@[@(10.f), @(3.f), @(10.f), @(3.f)]];
    yRightAxis.labelProvider = [ThousandsLabelProvider new]; // For more info see the LabelProvider API Documentation
    yRightAxis.tickLabelStyle = [[SCIFontStyle alloc] initWithFontDescriptor:tickFontDescriptor andTextColor:UIColor.greenColor];
    yRightAxis.titleStyle = [[SCIFontStyle alloc] initWithFontDescriptor:titleFontDescriptor andTextColor:UIColor.greenColor];
    ...
    yRightAxis.majorTickLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.purpleColor thickness:1];
    yRightAxis.minorTickLineLength = 2;
    yRightAxis.minorTickLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.redColor thickness:0.5];
    ...
    yLeftAxis.majorGridLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.greenColor thickness:1];
    yLeftAxis.minorGridLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.yellowColor thickness:0.5 strokeDashArray:@[@(10.f), @(3.f), @(10.f), @(3.f)]];
    yLeftAxis.labelProvider = [BillionsLabelProvider new]; // For more info see the LabelProvider API Documentation
    yLeftAxis.tickLabelStyle = [[SCIFontStyle alloc] initWithFontDescriptor:tickFontDescriptor andTextColor:UIColor.purpleColor];
    yLeftAxis.titleStyle = [[SCIFontStyle alloc] initWithFontDescriptor:titleFontDescriptor andTextColor:UIColor.purpleColor];
    ...
    yLeftAxis.majorTickLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.blackColor  thickness:1];
    yLeftAxis.minorTickLineLength = 2;
    yLeftAxis.minorTickLineStyle = [[SCISolidPenStyle alloc] initWithColor:UIColor.blackColor  thickness:0.5];
    ...
    candlestickSeries.strokeUpStyle = [[SCISolidPenStyle alloc] initWithColorCode:0xFF00FF00 thickness:1];
