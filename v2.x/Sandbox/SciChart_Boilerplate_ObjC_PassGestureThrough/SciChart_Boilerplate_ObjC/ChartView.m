...
@interface CustomGestureHandler : SCIGestureController

@end

@implementation CustomGestureHandler
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _surface = view;
        _surface.gestureController = [[CustomGestureHandler alloc] initWithParent:_surface View:_surface];
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        [SCIChartSurface setDisplayLinkRunLoopMode:NSRunLoopCommonModes];
        SCIChartSurface * view = [[SCIChartSurface alloc]initWithFrame:self.bounds];
        _surface = view;
        _surface.gestureController = [[CustomGestureHandler alloc] initWithParent:_surface View:_surface];
        [_surface setTranslatesAutoresizingMaskIntoConstraints:NO];
...
-(void) addModifiers{
    ...
    zpm.direction = SCIDirection2D_XDirection;
    zpm.zoomExtentsY = NO;
