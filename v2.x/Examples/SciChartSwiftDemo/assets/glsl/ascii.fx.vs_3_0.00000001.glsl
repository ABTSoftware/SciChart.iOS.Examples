...
void main ()
{
  ...
  resTexCoord_3 = (resTexCoord_3 + (0.055 * v_6.xy));
  ...
  highp vec3 tmpvar_9;
  tmpvar_9.z = 0.0;
  tmpvar_9.xy = (vPosition.w * v_8.zw);
  _position_7.xyz = (vPosition.xyz + ((
    -(tmpvar_9.x)
   * CameraSide) + (tmpvar_9.y * CameraUp)));
  _position_7.w = 1.0;
