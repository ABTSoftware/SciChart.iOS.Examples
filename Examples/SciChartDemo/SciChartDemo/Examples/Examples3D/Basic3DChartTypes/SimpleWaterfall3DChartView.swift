...
class SimpleWaterfall3DChartView: SingleChartLayout3D {
    ...
    override func initExample() {
        ...
        SCIUpdateSuspender.usingWith(surface) {
            ...
            self.surface.chartModifiers.add(items: ExampleViewBase.createDefault3DModifiers(), SCIVertexSelectionModifier3D())
        }
    }
