...
//
// SCSHitTestAPIChart.swift is part of the SCICHART® Examples. Permission is hereby granted
...
class SCSHitTestAPIChart: SingleChartLayout {
    ...
    @objc fileprivate func handleSingleTap(_ recognizer:UITapGestureRecognizer) {
        ...
        perform(#selector(SCSHitTestAPIChart.dismissAlert), with: _alertPopup, afterDelay: 1)
    }
