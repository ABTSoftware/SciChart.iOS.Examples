...
class SCSListChartsController: UITableViewController {
    ...
    let cellId = "CellId"
    let listChartsName = ["SCSLineChartView", "SCSDigitalLineChartView", "SCSUsingPointMarkers", "SCSUsingRolloverModifierChartView","SCSColumnChartView", "SCSMountainChartView", "SCSDigitalMountainChartView", "SCSCandlestickChartView", "SCSScatterSeriesChartView", "SCSHeatmapChartView", "SCSBubbleChartView", "SCSBandChartView", "SCSDigitalBandChartView","SCSStackedMountainChartView", "SCSECGChartView", "SCSAnnotationsChartView", "SCSMultipleXAxesChartView", "SCSSyncMultiChartView", "SCSLinePerformanceChartView", "SCSAppendSpeedTestSciChart", "SCSFIFOSpeedTestSciChart", "SCSNxMSeriesSpeedTestSciChart", "SCSScatterSpeedTestSciChart", "SCSSeriesAppendingTestSciChart", "SCSRealtimeTickingStockChartView", "SCSMultiPaneStockChartView", "SCSPalettedChartView", "SCSLegendChartView", "SCSUsingTooltipModifierChartView", "SCSUsingCursorModifierChartView", "SCSRolloverCustomizationChartView", "SCSCursorCustomizationChartView", "SCSTooltipCustomizationChartView", "SCSImpulseChartView", "SCSCustomModifierView", "SCSErrorBarsChartView", "SCSFanChartView", "SCSColumnDrillDownView", "SCSStackedColumnChartView", "SCSStackedColumnSideBySideChartView", "SCSStackedBarChartView", "SCSThemeProviderUsingChartView", "SCSThemeCustomChartView", "SCSSeriesSelectionView", "SCSPanAndZoomChartView", "SCSDragAxisToScaleChartView", "SCSSecondaryYAxesChartView", "SCSVerticalChartView", "SCSLogarithmicAxisChartView", "SCSOscilloscopeChartView", "SCSAddRemoveSeries"];
